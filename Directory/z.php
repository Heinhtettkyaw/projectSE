...
window.onclick = function(event) {
  if (event.target == modal) {
    modal.style.display = "none";
		...
		<h1 style="font-size: 20px; margin-left: 30px;">Name starts With 'Z'</h1>
		
<div class="row">
  <div class="column">
    <div class="card">
      <img src="boy.jpg" alt="Zar Lwin Htet" style="width:100%">
      <div class="container">
        <h2>Zar Lwin Htet</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
      
        <p>zarlwinhtet@uit.edu.mm</p>
        <p>09-999999999</p>
  ...
  <div class="column">
    <div class="card">
      <img src="boy.jpg" alt="Zarni Paing Sett" style="width:100%">
      <div class="container">
        <h2>Zarni Paing Sett</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
      
        <p>zarnipaingsett@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Zaw Lin Htike.jpg" alt="Zaw Lin Htike" style="width:100%">
      <div class="container">
        <h2>Zaw Lin Htike</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>
        	zawlinhtike@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
