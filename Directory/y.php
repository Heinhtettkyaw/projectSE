...
<html lang="en">
	...
	<script type="text/javascript" src="javaScript.js"></script>
			...
			footer
			{ color: black; text-align: center; padding: 20px;background-color: #333; color: white; }
...
window.onclick = function(event) {
  if (event.target == modal) {
    modal.style.display = "none";
		...
		<h1 style="font-size: 20px; margin-left: 30px;">Name starts With 'Y'</h1>
		
		<div class="row">
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/yamineaindray.jpg" alt="Yamin Eaindray" style="width:100%">
      <div class="container">
        <h2>Yamin Eaindray</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>yamineaindray@uit.edu.mm</p>
        <p>09-999999999</p>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/yelinsoe.jpg" alt="Ye Lin Soe" style="width:100%">
      <div class="container">
        <h2>Ye Lin Soe</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>yelinsoe@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/yeswanyee.jpg" alt="Yell Swan Yee" style="width:100%">
      <div class="container">
        <h2>Yell Swan Yee</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>yellswanyee@uit.edu.mm</p>
         <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="../Directory/boy.jpg" alt="Yinn Myat Noe Lwin" style="width:100%">
      <div class="container">
        <h2>Yinn Myat Noe Lwin</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>yinnmyatnoelwin@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/yoonnaychilin.jpg" alt="Yoon Nay Chi Lin" style="width:100%">
      <div class="container">
        <h2>Yoon Nay Chi Lin</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>yoonnaychilin@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="boy.jpg" alt="Yune Su Nadi" style="width:100%">
      <div class="container">
        <h2>Yune Su Nadi</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>yunesunadi@uit.edu.mm</p>
         <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/yunnwatikyaw.jpg" alt="Yunn Wati Kyaw" style="width:100%">
      <div class="container">
        <h2>Yunn Wati Kyaw</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>yunnwatikyaw@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
