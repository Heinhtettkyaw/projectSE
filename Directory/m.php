...
window.onclick = function(event) {
  if (event.target == modal) {
    modal.style.display = "none";
		...
		<h1 style="font-size: 20px; margin-left: 30px;">Name starts With 'M'</h1>

	<div class="row">
  		<div class="column">
   		 <div class="card">
      	<img src="ProfilePicture/MayThaZinNaing.png" alt="May Thazin Naing" style="width:100%">
     	 <div class="container">
        <h2>May Thazin Naing</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>maythazinnaing@uit.edu.mm</p>
         <p>09-999999999</p>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/May Yin Moe.jpg" alt="May Yin Moe" style="width:100%">
      <div class="container">
        <h2>May Yin Moe</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
 
        <p>mayyinmoe@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Mehm Kha Mon.jpg" alt="Min Khant Mon" style="width:100%">
      <div class="container">
        <h2>Mehm Kha Mon</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>minkhantmon@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Min Thant Kyaw.jpg" alt="Min Thant Kyaw" style="width:100%">
      <div class="container">
        <h2>Min Thant Kyaw</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>minthantkyaw@uit.edu.mm</p>
         <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Min Khant Paing.jpg" alt="Minn Khant Paing" style="width:100%">
      <div class="container">
        <h2>Minn Khant Paing</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
 
        <p>minnkhantpaing@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
