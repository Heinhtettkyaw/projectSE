...
window.onclick = function(event) {
  if (event.target == modal) {
    modal.style.display = "none";
		...
		<h1 style="font-size: 20px; margin-left: 30px;">Name starts With 'P'</h1>
		
		<div class="row">
  <div class="column">
    <div class="card">
      <img src="boy.jpg" alt="Pan Khin Khin Zaw" style="width:100%">
      <div class="container">
        <h2>Pan Khin Khin Zaw</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>pankhinkhinzaw@uit.edu.mm</p>
         <p>09-999999999</p>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Pan Pwint Htun.jpg" alt="Pann Pwint Htun" style="width:100%">
      <div class="container">
        <h2>Pann Pwint Htun</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>panpwinthtun@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Pyae Su Khine.jpg" alt="Pyae Su Khaing" style="width:100%">
      <div class="container">
        <h2>Pyae Su Khaing</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
     
        <p>pyaesukhaing@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
