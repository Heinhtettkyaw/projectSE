...
<!--	Notification_modal_box-->
					...
					<div id="main">
						...
						<a class="alpha btn" style="font-size: 20px;" href="Dindex.php">Home </a>
		...
		<h1 style="font-size: 20px; margin-left: 30px;">Name starts With 'K'</h1>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Kaung Htet Zaw.jpg" alt="Kaung Htet Zaw" style="width:100%">
      <div class="container">
        <h2>Kaung Htet Zaw</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
      
        <p>kaunghtetzaw@uit.edu.mm</p>
        <p>09-999999999</p>
  ...
  <div class="column">
    <div class="card">
      <img src="../Directory/ProfilePicture/Kaung Sat Sithu.jpg" alt="Kaung Sat Sithu" style="width:100%">
      <div class="container">
        <h2>Kaung Sat Sithu</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>kaungsatsithu@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="../Directory/ProfilePicture/KhaingPhyoZaw.png" alt="Khaing Phyo Zaw" style="width:100% ">
      <div class="container">
        <h2>Khaing Phyo Zaw</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>khaingphyozaw@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Khin Kaung Nge.jpg" alt="Khin Kaung Nge" style="width:100%">
      <div class="container">
        <h2>Khin Kaung Nge</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>khinkaungnge@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Khin Nyein Thu.png" alt="Khin Nyein Thu" style="width:100%">
      <div class="container">
        <h2>Khin Nyein Thu</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>khinnyeinthu@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/KhinThiriKyaw.jpg" alt="Khin Thiri Kyaw" style="width:100%">
      <div class="container">
        <h2>Khin Thiri Kyaw</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>khinthirikyaw@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="boy.jpg" alt="Khine Thinzar Soe" style="width:100%">
      <div class="container">
        <h2>Khine Thinzar Soe</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>khinethinzarsoe@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
