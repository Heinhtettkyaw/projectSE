...
window.onclick = function(event) {
  if (event.target == modal) {
    modal.style.display = "none";
		...
		<h1 style="font-size: 20px; margin-left: 30px;">Name starts With 'E'</h1>

		<div class="row">
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/einyeinthu.jpg" alt="Ei Nyein Thu" style="width:100%">
      <div class="container">
        <h2>Ei Nyein Thu</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
         <p>einyeinthu@uit.edu.mm</p>
         <p>09-999999999</p>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/eishwesintun.jpg" alt="Ei Shwe Sin Tun" style="width:100%">
      <div class="container">
        <h2>Ei Shwe Sin Tun</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>eishwesintun@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
