	...
	<head>
		...
		<style>
				...
				*, *:before, *:after {
				...
				.alpha-btn a:hover { background-color: black; color: white; padding: 10px;}
...
-->
		...
		<h1 style="font-size: 20px; margin-left: 30px;">Name starts With 'A'</h1>

		
		<div class="row">
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Aung Khant Kyaw.jpg" alt="Aung Khant Kyaw" style="width:100%">
      <div class="container">
        <h2>Aung Khant Kyaw</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>aungkhantkyaw@uit.edu.mm</p>
        <p>09-999999999</p>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Aung Khant Soe.jpg" alt="Aung Khant Soe" style="width:100%">
      <div class="container">
        <h2>Aung Khant Soe</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
 
        <p>aungkhantsoe@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Aye Myat Thu.jpg" alt="Aye Myat Thu" style="width:100%">
      <div class="container">
        <h2>Aye Myat Thu</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>ayemyatthu@uit.edu.mm</p>
         <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
