...
window.onclick = function(event) {
  if (event.target == modal) {
    modal.style.display = "none";
		...
		<h1 style="font-size: 20px; margin-left: 30px;">Name starts With 'T'</h1>
		
		<div class="row">
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Thar Chit Nyi Nyi.jpg" alt="Thar Chit Nyi Nyi" style="width:100%">
      <div class="container">
        <h2>Thar Chit Nyi Nyi</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>tharchitnyinyi@uit.edu.mm</p>
        <p>09-999999999</p>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/TharaphiLwin.png" alt="Tharaphi Lwin" style="width:100%">
      <div class="container">
        <h2>Tharaphi Lwin</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
     
        <p>tharaphilwin@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/ThiriMinThu.png" alt="Thiri Minn Thu" style="width:100%">
      <div class="container">
        <h2>Thiri Minn Thu</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>thiriminnthu@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
