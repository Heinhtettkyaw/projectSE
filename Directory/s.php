...
window.onclick = function(event) {
  if (event.target == modal) {
    modal.style.display = "none";
		...
		<h1 style="font-size: 20px; margin-left: 30px;">Name starts With 'S'</h1>
		
		<div class="row">
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Saw Lu Naung.jpg" alt="Saw Lu Naung" style="width:100%">
      <div class="container">
        <h2>Saw Lu Naung</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>sawlunaung@uit.edu.mm</p>
        <p>09-999999999</p>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Sithu Aung.jpg" alt="Sithu Aung" style="width:100%">
      <div class="container">
        <h2>Sithu Aung</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>sithuaung@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Sithu Htut.jpg" alt="Sithu Htut" style="width:100%">
      <div class="container">
        <h2>Sithu Htut</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>sithuhtut@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Su Htet Thinzar.jpg" alt="Su Htet Thinzar" style="width:100%">
      <div class="container">
        <h2>Su Htet Thinzar</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>suhtetthinzar@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Su Yanant Hlaing.jpg" alt="Su Yanant Hlaing" style="width:100%">
      <div class="container">
        <h2>Su Yanant Hlaing</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
       
        <p>suyananthlaing@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/Sue Sue.jpg" alt="Sue Sue" style="width:100%">
      <div class="container">
        <h2>Sue Sue</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>suesue@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
