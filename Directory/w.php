...
window.onclick = function(event) {
  ...
  <button class="alpha btn" onclick="window.location.href='a.php'">A</button>
		...
		<h1 style="font-size: 20px; margin-left: 30px;">Name starts With 'W'</h1>
		
	<div class="row">
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/warsopoo.jpg" alt="Warso Phoo" style="width:100%">
      <div class="container">
        <h2>Warso Phoo</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
        
        <p>warsophoo@uit.edu.mm</p>
        <p>09-999999999</p>
  ...
  <div class="column">
    <div class="card">
      <img src="ProfilePicture/wuttyeewin.jpg" alt="Wutyee Winn" style="width:100%">
      <div class="container">
        <h2>Wuttyee Winn</h2>
        <p class="title">UIT 2nd year Section(B) student</p>
      
        <p>wuttyeewin@uit.edu.mm</p>
        <p>09-999999999</p>
         <p>No.(1), May Road, Hlaing Township, Yangon</p>
      </div>
    </div>
