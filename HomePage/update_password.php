      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<li class="active"><a href="update_password.php"><span class="glyphicon glyphicon-user"></span> Update Password</a></li>
...
?>
<h3 style="margin-top: -180px; margin-bottom: 50px;">Update Password</h3>
<form method="post">
