      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			      ...
			      <li class="active"><a href="remind.php">&#9881; Set Reminder</a></li>
            <li><a href="displayremind.php">&#9781; Show Reminder</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<h3 style="margin-top: -90px;">Set Reminder</h3>
			<form method="POST" enctype="multipart/form-data" action="../remind/remindAction.php?email=<?= $_SESSION['user'] ?>">
