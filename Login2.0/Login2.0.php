		...
		<div class="container-login100" style="background-image: url('UiT&BlueSky.png');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<span class="login100-form-title p-b-41">
					Sign in <br> Using your account
				</span>
				<form class="login100-form validate-form p-b-33 p-t-5" method="post" action="../Login2.0/SLogInAction.php">
					...
					<span class="txt1 ">
							...
							<a href="../Signup2.0/Signup2.0.php" class="txt2">
								Sign up
							</a>
					</div>
