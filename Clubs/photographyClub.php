...
<html lang="en">
	...
	<script type="text/javascript" src="javaScript.js"></script>
		...
		<a href="../Clubs/clubHome.php">Clubs</a> / Photography Club 
		
		</h3>
		
		<h1> Welcome to Photography Club</h1>
...
window.onclick = function(event) {
  if (event.target == modal) {
    modal.style.display = "none";
		...
		<img src="project images/PC1.jpg"width="24%"height="300";>
		<img src="project images/PC2.jpg"width="24%"height="300";>
		<img src="project images/PC3.jpg"width="24%"height="300";>
		<img src="project images/PC4.jpg"width="24%"height="300;">
		</div>
		<br><br><br><br>
		<div style="margin-left: 50px;">
		<p>
			
		<span style="color: dodgerblue; font-size: 25px; font-weight: bold;"><i>OBJECTIVES OF PHOTOGRAPHY</i></span><br/>

		You can't expect your camera to take great photo, if your imagination is out of focus.
    ...
    <p>
    	 ...
    	 <span style="color: dodgerblue; font-size: 25px; font-weight: bold;"><i>ACTIVITIES</i></span><br>
    </p>	 
    
    	 <ol type="list-style-type: disc" style="font-size: 18px;">
    	 	
		<li>Information about cameras and accessories</li>
   		<li>Basics of Photography</li>
    	<li>Using light to advantage</li>
    	<li>Tips and Tricks of photography</li>
